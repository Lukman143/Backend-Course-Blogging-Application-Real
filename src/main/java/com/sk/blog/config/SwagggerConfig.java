...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application : Backend App",
				"This project is developed by Learn Code With Shaikh", "1.0", "Terms of Service",
				new Contact("Lukman", "https://learncodewithshaikh.com", "learncodewithshaikh@gmail.com"),
